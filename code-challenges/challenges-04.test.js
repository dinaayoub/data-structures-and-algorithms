...
const generateSubmitButton = () => {
  // Solution code here...
  var newInputButton = '<button type="button">submit</button>';
  $('form').append(newInputButton);
};
...
const isCapitalized = (str) => {
  // Solution code here...
  var matches = [];
  matches = str.match(/[A-Z][A-Za-z]{0,}/g);
