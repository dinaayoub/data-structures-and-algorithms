...
const templatingWithMustache = () => {
  ...
  var arrayOfRenderedCharacters =[];
  characters.forEach(char => {
    arrayOfRenderedCharacters.push(Mustache.render(template,char));
  })
  return arrayOfRenderedCharacters;
};
...
const hasChildrenValues = (arr, character) => {
  ...
  if (index >=0 && arr[index].children) return 1;
  return 0;
};
